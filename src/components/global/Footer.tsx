      ...
      <div className='text-center text-sm'>
        <div className='flex flex-row justify-center gap-4 mb-3'>
          <a
            ...
            aria-label='GitHub'
            className='w-6 h-6 hover:text-[#000000] duration-200'
          >
            <GitHubSVG />
          </a>
          <a
            ...
            aria-label='LinkedIn'
            className='w-6 h-6 hover:text-[#0A66C2] duration-200'
          >
            <LinkedInSVG />
          </a>
          <a
          ...
          <a
            ...
            className='w-6 h-6 hover:text-[#00AAEC] duration-200'
          >
            <TwitterSVG />
          </a>
          <a
            ...
            aria-label='Email'
            className='w-6 h-6 hover:text-blue-600 duration-200'
          >
            <EmailSVG />
          </a>
        </div>
